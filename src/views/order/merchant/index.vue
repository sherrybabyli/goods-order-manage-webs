<template>
    <div class="app-container">
        ...
        <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
                <el-button
                        ...
                        plain
                        @click="handleExport"
                        v-hasPermi="['order:merchant:export']"
                >导出
                </el-button>
            </el-col>
        ...
        <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="商户联系人" align="center" prop="contactName"/>
            <el-table-column label="商户联系方式" align="center" prop="contactTel"/>
...
<script setup name="Notice">
    import {pageMerchantList} from "@/api/order/index";
    ...
    function handleExport() {
        ...
        proxy.download("system/orderManage/merchantOrderExport", {
            ...queryParams.value,
        }, `商户订单数据_${new Date().getTime()}.xlsx`);
    }
    ...
    function getList() {
        ...
        pageMerchantList(queryParams.value).then(response => {
